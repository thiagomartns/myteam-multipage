...
export const Footer = () => {
  return (
    <section className="bg-dark-green flex flex-col gap-5 items-center justify-center py-10 text-white">
      <div className="text-white flex flex-col gap-5 items-center sm:flex-row sm:justify-between sm:w-full sm:px-5">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:w-full sm:px-5">
